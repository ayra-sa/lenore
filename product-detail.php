      ...
      <div class="collapses navbar-collapses" id="navbarNavbar">
        ...
        <ul class="navbar-nav me-auto ps-lg-0" style="padding-left: 0.15rem">
          ...
          <li class="nav-item dropdown position-static">
            <a class="nav-link active dropdown-toggle" href="./index.php#product" id="navbarDropdown" role="button"
          ...
          <li><a class="nav-link " href="./projects-gallery.php">Projects</a></li>
        ...
        <div class="container">
          <nav aria-label="breadcrumb mb-3">
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item">
                <a href="products-list.php">Interior</a>
              </li>
          ...
          <div class="row justify-content-center mt-5">
            ...
            <div class="col-lg-7 col-md-7">
              <table class="table">
                <tbody>
                  <tr>
                    <td colspan="2" class="title-prod"><p>interrior</p></td>
                  </tr>
                  <tr>
                    <td colspan="2" class="title-prod"><h4>LNHS</h4></td>
                  </tr>
                  <tr>
                    <td>Category</td>
                    <td>Spot</td>
              ...
              <div class="share d-flex align-items-center">
                <span>Share:</span>
                <div class="ms-3 soc d-flex gap-2">
                  <a href="#">
                    <img
                      src="assets/Blog Detail/whatsapp.png"
                      alt="socmed"
                      class="img-fluid"
                    />
                  </a>
                  ...
                  <a href="#">
                    <img
                      src="assets/Blog Detail/twitter.png"
                      alt="socmed"
                      class="img-fluid"
                    />
                  </a>
                  <a href="#">
                    <img
                      src="assets/Blog Detail/gmail.png"
                      alt="socmed"
                      class="img-fluid"
                    />
                  </a>
